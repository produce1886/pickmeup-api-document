...
|major|string|선택|사용자 전공|
|region|string|선택|사용자 활동 지역|
|interests|string|선택|사용자 관심분야|
|birthPublic|boolean|값 없을 시 자동으로 false|사용자 생년월일 공개 여부|
|universityPublic|boolean|값 없을 시 자동으로 false|사용자 대학 공개 여부|
|regionPublic|boolean|값 없을 시 자동으로 false|사용자 활동 지역 공개 여부|
|interestsPublic|boolean|값 없을 시 자동으로 false|사용자 관심 분야 공개 여부|
